...
exports.run = async (client, message, args, tools) => {
    try {
        ...
        let embeds = [];
        let work = await Axios.get("https://ao3api.williamvongphan.repl.co/load?id=" + inputid)
        ...
        if (work.data.chapters > 1) {
            let chapters = await Axios.get("https://ao3api.williamvongphan.repl.co/loadchapters?id=" + inputid)
        ...
        new Pagination.Embeds()
            ...
            .setURL("https://archiveofourown.org/works/" + inputid)
...
exports.help = {
    name: 'load-fanfic',
    description: 'Loads a fanfic from AO3 based on id.',
    usage: 'load-fanfic <id>',
};