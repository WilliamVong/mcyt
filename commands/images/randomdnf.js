...
exports.run = async (client, message, args, tools) => {
    ...
    const response = await Axios.get("http://api.tumblr.com/v2/tagged?tag=dreamnotfound&api_key=" + process.env.tumblr)
...
exports.help = {
    name: 'randomdnf',
    description: 'Fetches a random DNF post on Tumblr.',
    usage: 'randomdnf',
};